...
Shader "AdultLink/VerticalDissolve"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			o.Emission.r = min(1, o.Emission.r);
			o.Emission.g = min(1, o.Emission.g);
			o.Emission.b = min(1, o.Emission.b);
			...
			ColoredBorder169.a *= 2;
			o.Alpha = max(_Basecolor.a, ColoredBorder169.a);
